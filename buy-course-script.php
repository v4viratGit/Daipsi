...
{  
    ...
    $insert="insert into purchases (users_email,course_name,course_link,course_amount,expiry_date) VALUE ('$users_email','$course_name','$course_link','$course_amount','$expiry_date')";
